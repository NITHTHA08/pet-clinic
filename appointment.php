                    ...
                    <div class="bg-light rounded h-100 d-flex align-items-center p-5">
                       ...
                       <br>
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <select name="pet"  class="form-select border-0" style="height: 55px;">
                                ...
                                <div class="col-12 col-sm-6">
                                    <select name="shift"  class="form-select border-0" style="height: 55px;">
                                        ...
                                        <option value="1">Morning Shift (9am-12pm)</option>
                                        <option value="2">Afternoon Shift (2pm-5pm)</option>
                                        <option value="3">Evening Shift (6pm-9pm)</option>
